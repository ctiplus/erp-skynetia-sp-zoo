...
<html lang="en">
    ...
    <head>
        ...
        Favicons
        =============================================== -->
        <link rel="shortcut icon" href="http://localhost:97/assets/images/favicon.ico">
        <link rel="apple-touch-icon" href="http://localhost:97/assets/images/apple-touch-icon.png">
        <link rel="apple-touch-icon" sizes="72x72" href="http://localhost:97/assets/images/apple-touch-icon-72x72.png">
        <link rel="apple-touch-icon" sizes="114x114" href="http://localhost:97/assets/images/apple-touch-icon-114x114.png">

        <!-- ==============================================
        Vendor Stylesheet
        =============================================== -->
        <link rel="stylesheet" href="http://localhost:97/assets/css/vendor/bootstrap.min.css">
        <link rel="stylesheet" href="http://localhost:97/assets/css/vendor/slider.min.css">
        <link rel="stylesheet" href="http://localhost:97/assets/css/main.css">
        <link rel="stylesheet" href="http://localhost:97/assets/css/vendor/icons.min.css">
        <link rel="stylesheet" href="http://localhost:97/assets/css/vendor/animation.min.css">
        <link rel="stylesheet" href="http://localhost:97/assets/css/vendor/gallery.min.css">
        <link rel="stylesheet" href="http://localhost:97/assets/css/vendor/cookie-notice.min.css">

        <!-- ==============================================
        Custom Stylesheet
        =============================================== -->
        <link rel="stylesheet" href="http://localhost:97/assets/css/default.css">
        <link rel="stylesheet" href="http://localhost:97/assets/css/theme-pink.css">
    ...
    <body>
            ...
            <nav data-aos="zoom-out" data-aos-delay="800" class="navbar navbar-expand">
                <div class="container header">
                    ...
                    <a class="navbar-brand" href="/">
                        ...
                        <!-- 
                            Custom Logo
                            <img src="http://localhost:97/assets/images/logo.svg" alt="Leverage">
                        -->
                    </a>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide slide-center">
                        ...
                        <video class="full-image" data-mask="70" playsinline autoplay muted loop>
                            <source src="http://localhost:97/assets/videos/project.mp4" type="video/mp4" />
                        </video> 

                        <!-- 
                            Suggestion: Add a video to your http://localhost:97/assets folder and configure it here.

                            <video type="video/mp4" class="full-image" data-mask="70" src="http://localhost:97/assets/videos/yourvideo.mp4" autoplay muted loop></video> 
                        -->
                ...
                <div class="row text-center">
                    <div class="col-12 gallery">
                        <a href="https://www.youtube.com/watch?v=7e90gBu4pas" class="square-image d-flex justify-content-center align-items-center">
                            ...
                            <img src="http://localhost:97/assets/images/news-4.jpg" class="fit-image" alt="Fit Image">
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center text-center items">
                    <div class="col-12 col-md-6 col-lg-4 item">
                        <div class="card featured">
                            ...
                            <div class="gallery">
                                <a href="http://localhost:97/assets/images/work-1.jpg">
                                    <img src="http://localhost:97/assets/images/work-1.jpg" alt="Visual Art">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4 item">
                        <div class="card">
                            ...
                            <div class="gallery">
                                <a href="http://localhost:97/assets/images/work-2.jpg">
                                    <img src="http://localhost:97/assets/images/work-2.jpg" alt="Abstract Design">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4 item">
                        <div class="card featured">
                            ...
                            <div class="gallery">
                                <a href="http://localhost:97/assets/images/work-3.jpg">
                                    <img src="http://localhost:97/assets/images/work-3.jpg" alt="Creative Painting">
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-container min-slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide slide-center item">
                                <img src="http://localhost:97/assets/images/logo-1.png" class="fit-image w-85" alt="Fit Image">
                            </div>
                            <div class="swiper-slide slide-center item">
                                <img src="http://localhost:97/assets/images/logo-2.png" class="fit-image w-85" alt="Fit Image">
                            </div>
                            <div class="swiper-slide slide-center item">
                                <img src="http://localhost:97/assets/images/logo-3.png" class="fit-image w-85" alt="Fit Image">
                            </div>
                            <div class="swiper-slide slide-center item">
                                <img src="http://localhost:97/assets/images/logo-4.png" class="fit-image w-85" alt="Fit Image">
                            </div>
                            <div class="swiper-slide slide-center item">
                                <img src="http://localhost:97/assets/images/logo-5.png" class="fit-image w-85" alt="Fit Image">
                            </div>
                            <div class="swiper-slide slide-center item">
                                <img src="http://localhost:97/assets/images/logo-6.png" class="fit-image w-85" alt="Fit Image">
                            </div>
                            <div class="swiper-slide slide-center item">
                                <img src="http://localhost:97/assets/images/logo-7.png" class="fit-image w-85" alt="Fit Image">
                            </div>
                            <div class="swiper-slide slide-center item">
                                <img src="http://localhost:97/assets/images/logo-8.png" class="fit-image w-85" alt="Fit Image">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        Vendor Scripts
        =============================================== -->
        <script src="http://localhost:97/assets/js/vendor/jquery.min.js"></script>
        <script src="http://localhost:97/assets/js/vendor/jquery.easing.min.js"></script>
        <script src="http://localhost:97/assets/js/vendor/jquery.inview.min.js"></script>
        <script src="http://localhost:97/assets/js/vendor/popper.min.js"></script>
        <script src="http://localhost:97/assets/js/vendor/bootstrap.min.js"></script>
        <script src="http://localhost:97/assets/js/vendor/ponyfill.min.js"></script>
        <script src="http://localhost:97/assets/js/vendor/slider.min.js"></script>
        <script src="http://localhost:97/assets/js/vendor/animation.min.js"></script>
        <script src="http://localhost:97/assets/js/vendor/progress-radial.min.js"></script>
        <script src="http://localhost:97/assets/js/vendor/bricklayer.min.js"></script>
        <script src="http://localhost:97/assets/js/vendor/gallery.min.js"></script>
        <script src="http://localhost:97/assets/js/vendor/shuffle.min.js"></script>
        <script src="http://localhost:97/assets/js/vendor/cookie-notice.min.js"></script>
        <script src="http://localhost:97/assets/js/vendor/particles.min.js"></script>
        <script src="http://localhost:97/assets/js/main.js"></script>
